...
class Plugin{
    ...
    public function showUpgradeMessage(){
        ...
        echo '<strong>Enlighter Plugin Upgrade:</strong> The Plugin has been upgraded to <strong>4.6.1-BETA1</strong>';
        echo '</p></div>';
    }
    ...
    public static function run($pluginName){
        ...
        if (self::$__instance==null){
            ...
            if ($version == '0.0.0'){
                // store new version
                update_option('enlighter-version', '4.6.1-BETA1');

            // plugin upgraded ?
            }else if (version_compare('4.6.1-BETA1', $version, '>')){
                // run upgrade hook
