...
namespace Enlighter;
class GoogleWebfontResources{
public static function getMonospaceFonts(){
return array (
  ...
  'Fira Code' => 'Fira+Code:regular,700',
  ...
  'Source Code Pro' => 'Source+Code+Pro:regular,italic,700,700italic',
